/*
 * -----------------------
 * CONTROL_01 : Conditions
 * -----------------------
 * 
 * Ce sketch démontre comment prendre des décisions pour
 * changer ce qu'il se passe dans un programme.
 *
 * Ce qu'on appelle une structure de contrôle, 
